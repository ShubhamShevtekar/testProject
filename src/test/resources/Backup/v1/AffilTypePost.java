...
public class AffilTypePost extends Reporting {

	String scenarioName = getClass().getSimpleName();
	String TestCaseDescription, scenarioType, userId, affiliationTypeCode, affiliationTypeName;
	String affiliationEffectiveDate, affiliationexpirationDate;	
	...
	static Logger logger = Logger.getLogger(AffilTypePost.class);
	...
	public void TC_01() {
		...
		try {
			...
			// ***get end point url
			String getEndPoinUrl = RetrieveEndPoints.getEndPointUrl("geoPost", fileName, level + ".affilType.post");
			...
			String expectMessage = resMsgs.affilTypePostSuccessNewMsg + affiliationTypeId1;
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null 
				...
				if (js.getString("data.affiliationTypeId") != null) {
					...
					if (internalMsg.equals(expectMessage)) {
						logger.info("Affiliation Type ID is getting generated and received in response: " + affiliationTypeId1);
						test.pass("Affiliation Type ID is getting generated and received in response: " + affiliationTypeId1);
						// ***send the input, response, DB result for validation
						String[] inputFieldValues = { userId, affiliationTypeId1, affiliationTypeCode, affiliationTypeName, userId ,affiliationEffectiveDate, affiliationexpirationDate};
						...
						String[] inputFieldNames = { "Input_UserName: ", "Response_AffiliationTypeId: ",
								"Input_affiliationTypeCode: ", "Input_affiliationTypeName: ", "Input_LastUpdateUserName: ","Input_affiliationEffectiveDate: ", "Input_affiliationexpirationDate: " };
						writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
						String[] dbFieldNames = { "DB_UserName: ", "DB_AffiliationTypeId: ", "DB_affiliationTypeCode: ",
								"DB_affiliationTypeName: ", "DB_LastUpdateUserName: ","DB_affiliationEffectiveDate: ","DB_affiliationexpirationDate: " };
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("affiliationTypeCode") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when sending the blank affiliationTypeCode");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when sending the blank affiliationTypeCode");
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null && (!meta.contains("timestamp"))
				...
				if (js.getString("data.affiliationTypeId") != null) {
					...
					if (internalMsg.equals(expectMessage)) {
						logger.info(
								"Affiliation Type ID is getting generated and received in response: " + affiliationTypeId1);
						test.pass("Affiliation Type ID is getting generated and received in response: " + affiliationTypeId1);
						test.pass("Response meta validation passed");
						test.pass("Response timestamp validation passed");
						test.pass("Response API version number validation passed");
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("affiliationTypeCode") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the affiliationTypeCode attribute is not passed in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the affiliationTypeCode attribute is not passed in JSON");
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("affiliationTypeCode") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the affiliationTypeCode is more than 10 characters length in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the affiliationTypeCode is more than 10 characters length in JSON");
		...
		try {
...

			{
				...
				if (errorMsg1.get(0).equals("affiliationTypeName") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the affiliationTypeNameis more than 65 characters length in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the affiliationTypeNameis more than 65 characters length in JSON");
					...
					test.fail("Expected error message is not getting received in response");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "",
							Wsstatus, "" + Wscode, responsestr, "Fail", "affiliationTypeName" + expectMessage);
					Assert.fail("Test Failed");
				}
			} else {
				if (Wscode != 400) {
				...
				ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "", Wsstatus,
						"" + Wscode, responsestr, "Fail", "affiliationTypeName" + expectMessage);
				Assert.fail("Test Failed");
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			if (getJMSResult != null) {
				...
				if (affiliationTypeCode != null) {
					...
					String[] JMSValue = { affiliationTypeId1, affiliationTypeCode, affiliationTypeName, affiliationEffectiveDate,affiliationexpirationDate};
	...
	public void testDataFields(String scenarioName, String testCaseId) {
		...
		affiliationEffectiveDate = inputData1.get(testCaseId).get("effectiveDate");
		affiliationexpirationDate = inputData1.get(testCaseId).get("expirationDate");
	}
