...
public class LanguagePost extends Reporting {
	...
	public void before() {
		...
		// =resultValidation.versionValidation(fileName, tokenKey, tokenVal,actuatorCommandeVersionURL);
	}
	...
	public void TC_01() {
		...
		try {
			...
			String payload = PostMethod.langPostRequest(userId, languageCode, languageName, nativeScriptLanguageName,
...
System.out.println("langPostPostQuery1 "+langPostPostQuery1);
				...
				for (int i = 0; i < translatedDOWs.size() / 2; i++) {
					...
					// ***get the result from DB
System.out.println("languagePostQuery2 "+languagePostQuery2);
				...
				if (js.getString("data.languageCode") != null) {
					...
					if (internalMsg.equals(expectMessage)) {
						...
						System.out.println("resFields "+resFields);
						...
						String[] inputFieldNames = { "Input_UserName: ", "Input_languageCode: ", "Input_languageName: ",
								"Input_nativeScriptLanguageName:", "Input_LastUpdateUserName: ", "Input_dowNbr1:",
						...
						String[] dbFieldNames = { "DB_UserName: ", "DB_languageCode: ", "DB_languageName: ",
								"DB_nativeScriptLanguageName:", "DB_LastUpdateUserName: ", "DB_dowNbr1:",
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("languageCode") && errorMsg2.get(0).equals(expectMessage)) {
					...
					String[] inputFieldNames = { "Input_UserName: ", "Input_languageCode: ", "Input_languageName: ",
							"Input_nativeScriptLanguageName:", "Input_dowNbr1:", "Input_transDowName1:", "Input_dowNbr2:",
	...
	public void TC_07() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.langPostRequestWithoutDOW(userId, languageCode,nativeScriptLanguageName, languageName,
					 translatedMOYs);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_08() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.langPostRequestWithoutMOY(userId, languageCode,nativeScriptLanguageName, languageName,
					 translatedDOWs);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_09() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.langPostRequestWithoutDOWAndMOY(userId, languageCode, nativeScriptLanguageName,languageName
					);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_11() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.langPostRequestWithoutlanguageCode(userId, languageCode, nativeScriptLanguageName,languageName,
					 translatedDOWs, translatedMOYs);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_12() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.langPostRequestWithoutEnglLangNm(userId, languageCode, nativeScriptLanguageName,languageName,
					 translatedDOWs, translatedMOYs);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_13() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.langPostRequestWithoutNatScrptLangNm(userId, languageCode, languageName,
					 translatedDOWs, translatedMOYs);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_16() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.langPostRequestWithoutMeta(userId, languageCode, languageName,
					nativeScriptLanguageName, translatedDOWs, translatedMOYs);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
		...
		try {
			...
			if (getJMSResult != null) {
				...
				if (languageCode != null) {
					...
					for (int i = 0; i < jsonArraytranslatedDOWs.length(); i++) {
						jObj = jsonArraytranslatedDOWs.getJSONObject(i);
						String languagePostQuery2 = query.langTrnslDowPostQuery(languageCode, jObj.optString("dowNbr"));
						// ***get the fields needs to be validate in DB
					...
					String[] jmsFieldNames = { "Response_languageCode:  ", "Response_languageName:  ",
							"Response_nativeScriptLanguageName: ", "Response_dowNbr1:  ", "Response_transDowName1:  ",
					...
					String[] dbFieldNames = { "DB_languageCode:   ", "DB_languageName:   ", "DB_nativeScriptLanguageName:  ",
