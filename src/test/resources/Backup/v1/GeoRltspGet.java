...
public class GeoRltspGet extends Reporting {
	...
	String TestCaseDescription, scenarioType, geopoliticalRelationshipTypeCode, fromGeopoliticalId, toGeopoliticalId, targetDate,
			endDate;
	...
	static Logger logger = Logger.getLogger(GeoRltspGet.class);
	...
	public void TC_01() {
		...
		try {
			...
			if (geopoliticalRelationshipTypeCode != "") {
				getEndPoinUrl = getEndPoinUrl + "relationshipTypeCode=" + geopoliticalRelationshipTypeCode;
			}
					...
					for (int j = 0; j < getResultDB.size(); j = j + fields.size()) {
						if (getResultDB.get(j).toString().equals(getResponseRows.get(j).toString())
							...
							String[] responseDbFieldNames = { "Response_fromGeopoliticalId: ",
									...
									"Response_geopoliticalRelationshipTypeCode: ", "DB_geopoliticalRelationshipTypeCode: ",
	...
	public void TC_02() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithTargetEndDatesGetQuery(geopoliticalRelationshipTypeCode, targetDate,
						endDate);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
	...
	public void TC_05() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithRltspCodeGetQuery(geopoliticalRelationshipTypeCode);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
				List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	public void TC_06() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithFromAndToGeoplIdGetQuery(geopoliticalRelationshipTypeCode,
	...
	public void TC_07() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithFromGeoplIdGetQuery(geopoliticalRelationshipTypeCode, fromGeopoliticalId);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
				List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
				...
				if (getResultDB.size() == responseRows.size() * fields.size()) {
					...
					for (int e = 0; e < getResultDB.size(); e = e + fields.size()) {
						for (int j = 0; j < getResultDB.size(); j = j + fields.size()) {
							if (getResultDB.get(j).toString().equals(getResponseRows.get(e).toString())
								...
								String[] responseDbFieldNames = { "Response_fromGeopoliticalId: ",
										...
										"DB_toGeopoliticalId: ", "Response_geopoliticalRelationshipTypeCode: ",
										"DB_geopoliticalRelationshipTypeCode: ", "Response_effectiveDate: ", "DB_effectiveDate: ",
						...
						if (!rowmatch) {
							test.fail("GeoplRltsp details are not matiching for the geoplId: " + geopoliticalRelationshipTypeCode);
							ex.writeExcel(fileName, "", TestCaseDescription, scenarioType, "NA", "", "", "", "",
									"GeoplRltsp details are not matiching for the geoplId: " + geopoliticalRelationshipTypeCode,
									"Fail", "");
						}
						rowmatch = false;
					}
	...
	public void TC_08() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithToGeoplIdGetQuery(geopoliticalRelationshipTypeCode, toGeopoliticalId);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
				List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	public void TC_09() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithFromToGeoplIdAndTargetEndDatesGetQuery(geopoliticalRelationshipTypeCode,
	...
	public void TC_12() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithFromGeoplIdGetAndTargetEndDatesQuery(geopoliticalRelationshipTypeCode,
	...
	public void TC_15() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithToGeoplIdGetAndTargetEndDatesQuery(geopoliticalRelationshipTypeCode,
