	        		...
	        		&& (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	        {
	    		...
	    		if(js.getString("data.uomTypeCode")!=null)
	    		{
	    			...
	    			if(internalMsg.equals(expectMessage) && uomTypeCode1.equals(uomTypeCode))
	    			{
	            		...
	            		String[] inputFieldNames = {"Input_uomTypeCode: ", "Input_uomTypeName: ", "Input_uomTypeDescription: ", "Input_LastUpdateUserName: "};
	            		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	            		String[] dbFieldNames = {"DB_uomTypeCode: ", "DB_uomTypeName: ", "DB_uomTypeDescription: ", "DB_LastUpdateUserName: "};
				...
				if(uomTypeCd!=null){
		    		...
		    		if(testResult){
	        			...
	        			String[] responseDbFieldNames = {"Response_uomTypeCode: ", "DB_uomTypeCode: ", 
	        					"Response_uomTypeNm: ", "DB_uomTypeName: ", "Response_uomTypeDesc: ", "DB_uomTypeDescription: "};
		    			...
		    			String[] responseDbFieldValues = {uomTypeCd,getResultDB.get(0),uomTypeNm,getResultDB.get(1),uomTypeDesc,getResultDB.get(2)};
	        			String[] responseDbFieldNames = {"Response_uomTypeCode: ", "DB_uomTypeCode: ", 
	        					"Response_uomTypeNm: ", "DB_uomTypeName: ", "Response_uomTypeDescription: ", "DB_uomTypeDescription: "};
	        			writableResult = Miscellaneous.geoFieldInputNames(responseDbFieldValues, responseDbFieldNames);
