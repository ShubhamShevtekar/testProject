...
public class GeoRltspTypePost extends Reporting{
	...
	{	
       	...
       	if(Wscode == 400 && meta!=null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
        	...
        	if(errorMgs2.get(0).equals(expectMessage)&&errorMgs1.get(0).equals("geopoliticalRelationshipTypeCode"))
			{
	        	...
	        	ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,"", "", Wsstatus, ""+Wscode,
						responsestr, "Fail", "geopoliticalRelationshipTypeCode"+expectMessage );
	        	Assert.fail("Test Failed");
	        }
	    }else 
	    {
        ...
        ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "", Wsstatus, ""+Wscode,
				responsestr1, "Fail", "geopoliticalRelationshipTypeCode"+expectMessage );
    	Assert.fail("Test Failed");
	...
	{	
		...
		try {
		    ...
		    if(getJMSResult!=null){
				...
				String geopoliticalRelationshipTypeCode=getJMSResult.getJSONObject("data").getString("geopoliticalRelationshipTypeCode");
				...
				if(geopoliticalRelationshipTypeCode!=null){
		    		...
		    		if(testResult){
		    			//***write result to excel  
	        			String[] responseDbFieldValues = {geopoliticalRelationshipTypeCode,getResultDB.get(0),areaRelationshipTypeDescription,getResultDB.get(1)};
	        			String[] responseDbFieldNames = {"Response_geopoliticalRelationshipTypeCode: ", "DB_geopoliticalRelationshipTypeCode: ","Response_areaRelationshipTypeDescription: ", "DB_areaRelationshipTypeDescription: "};
