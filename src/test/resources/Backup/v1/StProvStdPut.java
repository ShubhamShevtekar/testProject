			...
			if (Wscode == 200 && meta != null && Wsstatus.equalsIgnoreCase("SUCCESS") && (!meta.contains("timestamp"))
				...
				if (js.getString("data.stateProvinceCode") != null) {
					...
					if (internalMsg.equals(expectMessage)) {
						...
						String[] inputFieldValues = { organizationStandardCode, stateProvinceCode, stateProvinceName, effectiveDate, expirationDate,
								userId };
						...
						String[] inputFieldNames = { "Input_organizationStandardCode: ", "Input_stateProvinceCode: ", "Input_stateProvinceName: ",
								"Input_effectiveDate", "Input_expirationDate", "Input_LastUpdateUserName:" };
						writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
						String[] dbFieldNames = { "DB_organizationStandardCode: ", "DB_stateProvinceCode: ", "DB_stateProvinceName: ", "DB_effectiveDate",
						...
						if (testResult) {
							...
							String[] inputFieldValuesAudit = { organizationStandardCode, stateProvinceCode, stateProvinceName, effectiveDate,
							...
							if (testResult) {
								String[] inputFieldNamesAudit = { "Input_organizationStandardCode: ", "Input_stateProvinceCode: ",
								...
								String[] dbFieldNamesAudit = { "DB_organizationStandardCode: ", "DB_stateProvinceCode: ", "DB_stateProvinceName: ",
