...
public class CntryOrgStdPost extends Reporting {
	...
	String TestCaseDescription, scenarioType, userId, countryCode, countryShortName, countryFullName, organizationStandardCode,
					...
					if (internalMsg.equals(expectMessage)) {
						...
						if (testResult) {
							...
							String countryOrgStdPostAuditQuery = query.countryOrgStdPostAuditQuery(countryCode,
									countryShortName, countryFullName, organizationStandardCode, formatAuditEffectiveDate,
							...
							if (testResult) {
								String[] inputFieldNamesAudit = { "Input_UserName: ", "Response_GeoId: ",
										"Input_CountryShortName: ", "Input_CountryFullame: ", "Input_organizationStandardCode: ",
