...
public class HolidayPut extends Reporting{
	
	String scenarioName = getClass().getSimpleName();
	String TestCaseDescription, scenarioType, userId, holidayName, holidayParamText, holidayId;//, token;
	...
	static Logger logger = Logger.getLogger(HolidayPut.class);
	...
	{	
		...
		try {
			...
			//***get end point url
			String getEndPoinUrl = RetrieveEndPoints.getEndPointUrl("geoPut", fileName, level+".holiday.put");
			getEndPoinUrl = getEndPoinUrl+holidayId;
	        		...
	        		&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	        {
	    		...
	    		if(js.getString("data.holidayId")!=null)
	    		{
	    			...
	    			String expectMessage = resMsgs.holidayPutSuccessNewMsg+holidayId1;
	    			if(internalMsg.equals(expectMessage))
	    			{
	            		...
	            		String[] inputFieldValues = {holidayId1, holidayName, holidayParamText, userId};
	            		...
	            		String[] inputFieldNames = {"Response_HolidayId: ", "Input_HolidayName: ", "Input_holidayDateParameterText: ", "Input_LastUpdateUserName: "};
	            		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	            		String[] dbFieldNames = {"DB_HolidayId: ", "DB_HolidayName: ", "DB_holidayDateParameterText: ", "DB_LastUpdateUserName: "};
	...
	{	
        ...
        if(Wscode == 400 && actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
			...
			if(errorMsg1.get(0).equals("holidayName") && errorMsg2.get(0).equals(expectMessage))
			{
				...
				String[] inputFieldNames = {"Input_UserName: ", "Input_HolidayName: ", "Input_holidayDateParameterText: "};
        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	...
	{	
		...
		try {
	        ...
	        String timestamp = js.getString("meta.timestamp");
	        int Wscode= res.statusCode();
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta!=null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	        {
	        	logger.info("Response status validation passed: "+Wscode);
	        	test.pass("Response status validation passed: "+Wscode);
	        	test.pass("Response meta validation passed");
	...
	{	
		...
		String actualRespVersionNum = js.getString("meta.version");
        String timestamp = js.getString("meta.timestamp");
        String expectMessage = resMsgs.holidaylengthExceeds400CharMsg;
        int Wscode= res.statusCode();
        if(Wscode == 400 && meta!=null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
        	logger.info("Response status code 400 validation passed: "+Wscode);
        	...
        	test.pass("Response timestamp validation passed");test.pass("Response API version number validation passed");
        	//***error message validation
			if(errorMsg1.get(0).equals("holidayDateParameterText") && errorMsg2.get(0).equals(expectMessage))
			{
				String[] inputFieldValues = {userId, holidayName, holidayParamText};
				String[] inputFieldNames = {"Input_UserName: ", "Input_HolidayName: ", "Input_holidayDateParameterText: "};
        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
				...
				test.fail("Expected error message is not getting received in response");
	        	ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,"", "", Wsstatus, ""+Wscode,
						responsestr, "Fail", "holidayDateParamText"+expectMessage );
	        	Assert.fail("Test Failed");
	        }
	    }else {
	    	if(Wscode !=400){
	...
	{	
        ...
        if(Wscode == 404 && meta!=null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
        	...
        	if(errorMsg1.get(0).equals("Error") && errorMsg2.get(0).equals(expectMessage))
			{
				...
				String[] inputFieldNames = {"Input_UserName: ", "Input_HolidayName: ", "Input_holidayDateParameterText: "};
        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
        		logger.info("Expected error message is getting received in response when the Invalid holidayId (not exist in DB) is provided");
        		logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
    			logger.info("------------------------------------------------------------------");
        		test.pass("Expected error message is getting received in response when the Invalid holidayId (not exist in DB) is provided");
        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
				test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
			}else {
	...
	{	
        ...
        if(Wscode == 400 && meta!=null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
			...
			if(errorMsg1.get(0).equals("Error") && errorMsg2.get(0).equals(expectMessage))
			{
				...
				String[] inputFieldNames = {"Input_UserName: ", "Input_HolidayName: ", "Input_holidayDateParameterText: "};
        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
        		logger.info("Expected error message is getting received in response when the Invalid holidayId (alphabets) is provided");
        		logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
    			logger.info("------------------------------------------------------------------");
        		test.pass("Expected error message is getting received in response when the Invalid holidayId (alphabets) is provided");
        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
				test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
			}else {
	...
	{	
        ...
        if(Wscode == 400)
	    {
        	...
        	if(errorMsg1.get(0).equals("Error") && errorMsg2.get(0).equals(expectMessage))
			{
				...
				String[] inputFieldNames = {"Input_UserName: ", "Input_HolidayName: ", "Input_holidayDateParameterText: "};
        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
        		logger.info("Expected error message is getting received in response when the Invalid holidayId (special characters) is provided");
        		logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
    			logger.info("------------------------------------------------------------------");
        		test.pass("Expected error message is getting received in response when the Invalid holidayId (special characters) is provided");
        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
				test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
			}else {
	...
	{	
		...
		try {
			...
			String holidayDateParamText=getJMSResult.getJSONObject("data").getString("holidayDateParameterText");
			...
			if(hID!=null)
	        {
	    		...
	    		{
	    			//***write result to excel
        			String[] responseDbFieldValues = {hID,getResultDB.get(0),holidayName,getResultDB.get(1),holidayDateParamText,getResultDB.get(2)};
        			String[] responseDbFieldNames = {"Response_holidayId: ", "DB_holidayId: ", 
        					"Response_holidayName: ", "DB_holidayName: ", "Response_holidayDateParamText: ", "DB_holidayDateParamText: "};
	...
	public void testDataFields(String scenarioName, String testCaseId)
	{
		...
		holidayId = inputData1.get(testCaseId).get("holidayId");
	}
