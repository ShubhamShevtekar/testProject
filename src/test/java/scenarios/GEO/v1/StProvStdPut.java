...
public class StProvStdPut extends Reporting {
	...
	String TestCaseDescription, scenarioType, userId, organizationStandardCode, stateProvinceCode, stateProvinceName,
	...
	public void TC_01() {
		...
		try {
			...
			String payload = PostMethod.stProvStdPostRequest(userId, organizationStandardCode, stateProvinceCode,
			...
			String geoStProvStdPutCountQuery = query.stProvStdAuditPutCountQuery(stateProvinceCode);
			...
			if (Wscode == 200 && meta != null && Wsstatus.equalsIgnoreCase("SUCCESS") && (!meta.contains("timestamp"))
				...
				if (js.getString("data.stateProvinceCode") != null) {
					...
					String expectMessage = resMsgs.stProvStdPutSuccessMsg + stateProvinceCode1;
					if (internalMsg.equals(expectMessage)) {
						logger.info(
								"Success message with stateProvinceCode is getting received as expected in response");
						...
						String[] inputFieldValues = { organizationStandardCode, stateProvinceCode, stateProvinceName,
						...
						String[] inputFieldNames = { "Input_organizationStandardCode: ", "Input_stateProvinceCode: ",
								"Input_stateProvinceName: ", "Input_effectiveDate", "Input_expirationDate",
								"Input_LastUpdateUserName:" };
						writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
						String[] dbFieldNames = { "DB_organizationStandardCode: ", "DB_stateProvinceCode: ",
						...
						if (testResult) {
							...
							String geoStProvStdPostQueryAudit = query.stProvStdAuditQuery(stateProvinceCode,
									formatAuditEffectiveDate, formatAuditExpirationDate, stateProvinceName);
							// ***get the fields needs to be validate in DB
							...
							String[] inputFieldValuesAudit = { organizationStandardCode, stateProvinceCode,
									stateProvinceName, effectiveDate, expirationDate, userId, "1" };
							testResult = false;
							testResult = TestResultValidation.testValidationWithDB(res, inputFieldValuesAudit,
									getResultDBAudit, resFields);
							if (testResult) {
								String[] inputFieldNamesAudit = { "Input_organizationStandardCode: ",
								...
								String[] dbFieldNamesAudit = { "DB_organizationStandardCode: ",
										"DB_stateProvinceCode: ", "DB_stateProvinceName: ", "DB_effectiveDate",
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("organizationStandardCode") && errorMsg2.get(0).equals(expectMessage)) {
					String[] inputFieldValues = { userId, organizationStandardCode, stateProvinceCode,
							stateProvinceName, effectiveDate, expirationDate };
					String[] inputFieldNames = { "Input_UserName: ", "Input_organizationStandardCode: ",
							"Input_stateProvinceCode: ", "Input_stateProvinceName: ", "Input_effectiveDate",
	...
	public void TC_10() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.stProvStdPostRequestWithoutMeta(userId, organizationStandardCode,
					stateProvinceCode, stateProvinceName, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_11() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.stProvStdPostRequestWithoutorganizationStandardCode(userId,
					organizationStandardCode, stateProvinceCode, stateProvinceName, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_12() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.stProvStdPostRequestWithoutstateProvinceCode(userId, organizationStandardCode,
					stateProvinceCode, stateProvinceName, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
	...
	public void TC_13() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.stProvStdPostRequestWithoutstateProvinceName(userId, organizationStandardCode,
					stateProvinceCode, stateProvinceName, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
	...
	public void TC_14() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.stProvStdPostRequestWithoutEffectiveDt(userId, organizationStandardCode,
					stateProvinceCode, stateProvinceName, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
	...
	public void TC_15() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.stProvStdPostRequestWithoutExpirationDt(userId, organizationStandardCode,
					stateProvinceCode, stateProvinceName, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
	...
	public void TC_23() {
		...
		try {
			...
			if (Wscode == 404) {
				...
				test.pass("Response status code 404 validation passed: " + Wscode);
				// ***error message validation
				String expectMessage = resMsgs.invalidUrlMsgstProvPut1;
				if (internalMsg.equals(expectMessage)) {
					String[] inputFieldValues = { userId, organizationStandardCode, stateProvinceCode,
							stateProvinceName, effectiveDate, expirationDate };
					String[] inputFieldNames = { "Input_UserName: ", "Input_organizationStandardCode: ",
	...
	public void TC_24() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.stProvStdCommaMissingtRequest(userId, organizationStandardCode,
					stateProvinceCode, stateProvinceName, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_27() {
		...
		try {
			...
			if (getJMSResult != null) {
				...
				String organizationStandardCode = getJMSResult.getJSONObject("data")
						.getString("organizationStandardCode");
				...
				if (stateProvinceCode != null) {
					...
					String[] JMSValue = { geopoliticalId, organizationStandardCode, stateProvinceCode,
							stateProvinceName, formatEffectiveDateJMS, formatExpirationDateJMS };
					...
					if (testResult) {
						...
						String[] responseDbFieldValues = { geopoliticalId, getResultDB.get(0), organizationStandardCode,
								getResultDB.get(1), stateProvinceCode, getResultDB.get(2), stateProvinceName,
								getResultDB.get(3), formatEffectiveDateJMS, getResultDB.get(4), formatExpirationDateJMS,
								getResultDB.get(5) };
