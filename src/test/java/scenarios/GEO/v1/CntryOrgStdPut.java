...
public class CntryOrgStdPut extends Reporting {
	...
	public void TC_01() {
		...
		try {
			...
			List<String> getAuditBeforeCntResultDB = DbConnect.getResultSetFor(cntryOrgStdBeforePutQuery,
			...
			List<String> getAuditAfetrCntResultDB = DbConnect.getResultSetFor(cntryOrgStdBeforePutQuery, fieldsAuditcnt,
					fileName, testCaseID);
			...
			if (Wscode == 200 && meta != null && Wsstatus.equalsIgnoreCase("SUCCESS") && (!meta.contains("timestamp"))
				...
				// ***get the DB query
				String scriptPostQuery = query.countryOrgStdPostQuery(countryCode, countryShortName, countryFullName,
						organizationStandardCode, formatEffectiveDate, formatExpirationDate);
				...
				if (js.getString("data.organizationStandardCode") != null
					...
					if (internalMsg.equals(expectMessage)) {
						...
						String[] inputFieldValues = { geopId, countryShortName, countryFullName,
						...
						String[] inputFieldNames = { "Response_GeoId: ", "Input_CountryShortName: ",
						...
						String[] dbFieldNames = { "DB_GeoId: ", "DB_CountryShortName: ", "DB_CountryFullame: ",
								"DB_organizationStandardCode: ", "DB_effectiveDate: ", "DB_expirationDate: ",
						...
						if (testResult) {
							...
							String[] inputAuditFieldValues = { geopId, countryShortName, countryFullName,
									organizationStandardCode, effectiveDate, expirationDate, userId, "1" };
							testResult = false;
							testResult = TestResultValidation.testValidationWithDB(res, inputAuditFieldValues,
									getResultDBAudit, resFields);
							if (testResult) {
								String[] inputFieldNamesAudit = { "Response_GeoId: ", "Input_CountryShortName: ",
										"Input_CountryFullame: ", "Input_organizationStandardCode: ",
								...
								String[] dbFieldNamesAudit = { "DB_GeoId: ", "DB_CountryShortName: ",
								...
								ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,
										...
										"Fail", "Comparison between input data & DB data not matching and failed");
	...
	public void TC_27() {
		...
		try {
			...
			if (Wscode == 404) {
				...
				test.pass("Response status code 404 validation passed: " + Wscode);
				// ***error message validation
				String expectMessage = resMsgs.invalidUrlcountryOrgStdMsgstPut1;
				if (internalMsg.equals(expectMessage)) {
					String[] inputFieldValues = { userId, countryCode, countryShortName, countryFullName,
							organizationStandardCode, effectiveDate, expirationDate };
					String[] inputFieldNames = { "Input_UserName: ", "Input_CountryCode: ", "Input_CountryShortName: ",
	...
	public void TC_30() {
		...
		try {
			...
			String getEndPoinUrl = RetrieveEndPoints.getEndPointUrl("geoPut", fileName, level + ".cntryOrgStd.put");
			// ***send request and get response
			Response res = GetResponse.sendRequestPut(payload, "", token, getEndPoinUrl, fileName, testCaseID);
			String responsestr = res.asString();
			String responsestr1 = Miscellaneous.jsonFormat(responsestr);
			test.info("Response Recieved:");
			test.info(responsestr1.replaceAll("\n", "<br />"));
