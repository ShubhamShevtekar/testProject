...
public class DayOfWeekPut extends Reporting {
	...
	String TestCaseDescription, scenarioType, userId, dayOfWeekNbr, dayOfWeekShortName, dayOfWeekFullName;// ,
																											// token;
	...
	public void TC_01() {
		...
		try {
			...
			String payload = PostMethod.dayOfWeekPostRequest(userId, dayOfWeekNbr, dayOfWeekShortName,
					dayOfWeekFullName);
	...
	public void TC_02() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			// String payload = PostMethod.dayOfWeekPostRequest(userId,
			// dayOfWeekNbr, dayOfWeekShortName, dayOfWeekFullName);
			String payload = PostMethod.dayOfWeekPostRequestWithNulldayOfWeekNbr(userId, dayOfWeekNbr,
					dayOfWeekShortName, dayOfWeekFullName);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("dayOfWeekShortName") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the empty value is passed in JSON for dayOfWeekShortName ");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the empty value is passed in JSON for dayOfWeekShortName ");
					...
					test.fail("Expected error message is not getting received as expected in response");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "",
							Wsstatus, "" + Wscode, responsestr, "Fail", "dayOfWeekShortName " + expectMessage);
					Assert.fail("Test Failed");
				}
			} else {
				if (Wscode != 400) {
				...
				ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "", Wsstatus,
						"" + Wscode, responsestr, "Fail", "dayOfWeekShortName " + expectMessage);
				Assert.fail("Test Failed");
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void TC_05() {
		...
		try {
			...
			// ***send the data to create request and get request
			String payload = PostMethod.dayOfWeekPostRequestWithoutMeta(userId, dayOfWeekNbr, dayOfWeekShortName,
					dayOfWeekFullName);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
	...
	public void TC_06() {
		...
		try {
			...
			// ***send the data to create request and get request
			String payload = PostMethod.dayOfWeekPostRequestWithoutDOWNo(userId, dayOfWeekNbr, dayOfWeekShortName,
					dayOfWeekFullName);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("dayOfWeekNumber") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the dayOfWeekNumber attribute is not passed in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the dayOfWeekNumber attribute is not passed in JSON");
	...
	public void TC_07() {
		...
		try {
			...
			// ***send the data to create request and get request
			String payload = PostMethod.dayOfWeekPostRequestWithoutDOWShNm(userId, dayOfWeekNbr, dayOfWeekShortName,
					dayOfWeekFullName);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("dayOfWeekShortName") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the dayOfWeekShortName attribute is not passed in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the dayOfWeekShortName attribute is not passed in JSON");
	...
	public void TC_08() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.dayOfWeekPostRequestWithoutDOWFNm(userId, dayOfWeekNbr, dayOfWeekShortName,
					dayOfWeekFullName);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("dayOfWeekNumber") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the dayOfWeekNumber is more than 38 characters length in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the dayOfWeekNumber is more than 38 characters length in JSON");
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("dayOfWeekShortName") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the dayOfWeekShortName is more than 9 characters length in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the dayOfWeekShortName is more than 9 characters length in JSON");
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("dayOfWeekFullName") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the dayOfWeekFullName is more than 256 characters length in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the dayOfWeekFullName is more than 256 characters length in JSON");
					...
					test.fail("Expected error message is not getting received as expected in response");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "",
							Wsstatus, "" + Wscode, responsestr, "Fail", "dayOfWeekFullName " + expectMessage);
					Assert.fail("Test Failed");
				}
			} else {
				if (Wscode != 400) {
				...
				ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "", Wsstatus,
						"" + Wscode, responsestr, "Fail", "dayOfWeekFullName " + expectMessage);
				Assert.fail("Test Failed");
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void TC_14() {
		...
		try {
			...
			if (Wscode == 404) {
				...
				// ***error message validation
				String expectMessage = resMsgs.invalidUrldowputMsg1;
				if (internalMsg.equals(expectMessage)) {
					String[] inputFieldValues = { userId, dayOfWeekNbr, dayOfWeekShortName, dayOfWeekFullName };
					String[] inputFieldNames = { "Input_UserName: ", "Input_dayOfWeekNumber: ",
							"Input_dayOfWeekShortName: ", "Input_dayOfWeekFullName: " };
		...
		try {
			...
			if (Wscode == 404 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("dayOfWeekNumber") && errorMsg2.get(0).equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the invalid dayOfWeekNumber (not exist in DB) is passed in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the invalid dayOfWeekNumber (not exist in DB) is passed in JSON");
		...
		try {
			...
			if (Wscode == 400) {
				...
				if (internalMsg.equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the invalid dayOfWeekNumber (alphabets) is passed in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the invalid dayOfWeekNumber (alphabets) is passed in JSON");
		...
		try {
			...
			if (Wscode == 400) {
				...
				if (internalMsg.equals(expectMessage)) {
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when the invalid dayOfWeekNumber (special characters) is passed in JSON");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the invalid dayOfWeekNumber (special characters) is passed in JSON");
	...
	// newly added tc's for new changes
	@Test(priority = 2)
	public void TC_20() {
		String testCaseID = new Object() {
		}.getClass().getEnclosingMethod().getName();
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.dayofweekCommaMissingPostRequest(userId, dayOfWeekNbr, dayOfWeekShortName,
					dayOfWeekFullName);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
			// ***get end point url
			// String getEndPoinUrl =
			// RetrieveEndPoints.getEndPointUrl("geoPost", fileName, level +
			// ".holiday.post");
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("Error") && errorMsg2.get(0).equals(expectMessage)) {
					String[] inputFieldValues = { userId, dayOfWeekNbr, dayOfWeekShortName, dayOfWeekFullName };
					String[] inputFieldNames = { "Input_UserName: ", "Input_dayOfWeekNbr: ",
							"Input_dayOfWeekShortName: ", "Input_dayOfWeekFullName: " };
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
		...
		try {
			...
			if (getJMSResult != null) {
				...
				if (dayOfWeekNumber != null) {
					...
					// ***get the result from DB
					List<String> getResultDB = DbConnect.getResultSetFor(dayOfWeekJMSQuery, fields, fileName,
							testCaseID);
					...
					if (testResult) {
						// ***write result to excel
						String[] responseDbFieldValues = { dayOfWeekNumber, getResultDB.get(0), dayOfWeekFullName,
								getResultDB.get(1), dayOfWeekShortName, getResultDB.get(2) };
						String[] responseDbFieldNames = { "Response_dayOfWeekNumber: ", "DB_dayOfWeekNumber: ",
								"Response_dayOfWeekFullName: ", "DB_dayOfWeekFullName: ",
								"Response_dayOfWeekShortName: ", "DB_dayOfWeekShortName: " };
