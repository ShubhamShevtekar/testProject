...
public class GeoRltspGet extends Reporting {
	...
	String TestCaseDescription, scenarioType, geopoliticalRelationshipTypeCode, fromGeopoliticalId, toGeopoliticalId,
			targetDate, endDate;
	...
	public void TC_02() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithTargetEndDatesGetQuery(geopoliticalRelationshipTypeCode,
						targetDate, endDate);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
	...
	public void TC_07() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithFromGeoplIdGetQuery(geopoliticalRelationshipTypeCode,
						fromGeopoliticalId);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
				...
				if (getResultDB.size() == responseRows.size() * fields.size()) {
					...
					for (int e = 0; e < getResultDB.size(); e = e + fields.size()) {
						...
						if (!rowmatch) {
							test.fail("GeoplRltsp details are not matiching for the geoplId: "
									+ geopoliticalRelationshipTypeCode);
							ex.writeExcel(fileName, "", TestCaseDescription, scenarioType, "NA", "", "", "", "",
									"GeoplRltsp details are not matiching for the geoplId: "
											+ geopoliticalRelationshipTypeCode,
									"Fail", "");
						}
						rowmatch = false;
	...
	public void TC_08() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithToGeoplIdGetQuery(geopoliticalRelationshipTypeCode,
						toGeopoliticalId);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
	...
	public void TC_09() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithFromToGeoplIdAndTargetEndDatesGetQuery(
						geopoliticalRelationshipTypeCode, targetDate, endDate, fromGeopoliticalId, toGeopoliticalId);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
				List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	public void TC_12() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithFromGeoplIdGetAndTargetEndDatesQuery(
						geopoliticalRelationshipTypeCode, targetDate, endDate, fromGeopoliticalId);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
				List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	public void TC_15() {
		...
		try {
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null
				...
				String geoRsGetQuery = query.geopRltspWithToGeoplIdGetAndTargetEndDatesQuery(
						geopoliticalRelationshipTypeCode, targetDate, endDate, toGeopoliticalId);
				// ***get the fields needs to be validate in DB
				List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
				// ***get the result from DB
				List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	public void TC_24() {
		...
		try {
			...
			if (Wscode == 404) {
				...
				ValidationFields.timestampValidation(js, res);   ValidationFields.transactionIdValidation(js, res); 
				// ***error message validation
				String expectMessage = resMsgs.invalidUrlGeoRltspGet;
