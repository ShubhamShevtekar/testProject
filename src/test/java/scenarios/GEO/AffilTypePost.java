...
public class AffilTypePost extends Reporting{
	...
	String TestCaseDescription, scenarioType, userId, affilTypeCode, affilTypeName;
	...
	{	
		...
		try {
	        ...
	        String expectMessage = resMsgs.affilTypePostSuccessMsg+affilTypeId1;
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta!=null && timestamp!=null )
	        {
	    		...
	    		if(js.getString("data.affilTypeId")!=null)
	    		{
	    			...
	    			{
	    				logger.info("Affiliation Type ID is getting generated and received in response: "+affilTypeId1);
	    				test.pass("Affiliation Type ID is getting generated and received in response: "+affilTypeId1);
	    				//***send the input, response, DB result for validation
	            		String[] inputFieldValues = {userId, affilTypeId1, affilTypeCode, affilTypeName, userId};
	            		...
	            		String[] inputFieldNames = {"Input_UserName: ", "Response_AffiliationTypeId: ", "Input_affilTypeCode: ", "Input_affilTypeName: ", "Input_LastUpdateUserName: "};
	            		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	            		String[] dbFieldNames = {"DB_UserName: ", "DB_AffiliationTypeId: ", "DB_affilTypeCode: ", "DB_affilTypeName: ", "DB_LastUpdateUserName: "};
		...
		try {
	        ...
	        if(Wscode == 400 && meta!=null && timestamp!=null )
		    {
				...
				if(errorMsg1.get(0).equals("affilTypeCode") && errorMsg2.get(0).equals(expectMessage))
				{
	        		...
	        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	        		logger.info("Expected error message is getting received in response when sending the blank affilTypeCode");
	        		logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when sending the blank affilTypeCode");
		...
		try {
	        ...
	        if(Wscode == 400 && meta!=null && timestamp!=null)
		    {
	        	...
	        	if(errorMsg1.get(0).equals("affilTypeCode") && errorMsg2.get(0).equals(expectMessage))
				{
					...
					String[] inputFieldNames = {"Input_UserName: ", "Input_affilTypeCode: ", "Input_affilTypeName: "};
	        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	        		logger.info("Expected error message is getting received in response when the affilTypeCode attribute is not passed in JSON");
	        		logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the affilTypeCode attribute is not passed in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
		...
		try {
	        ...
	        if(Wscode == 400 && meta!=null && timestamp!=null )
		    {
				...
				if(errorMsg1.get(0).equals("affilTypeCode") && errorMsg2.get(0).equals(expectMessage))
				{
					...
					String[] inputFieldNames = {"Input_UserName: ", "Input_affilTypeCode: ", "Input_affilTypeName: "};
	        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	        		logger.info("Expected error message is getting received in response when the affilTypeCode is more than 10 characters length in JSON");
	        		logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the affilTypeCode is more than 10 characters length in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
		...
		try {
		    ...
		    
		    {
				...
				if(errorMsg1.get(0).equals("affilTypeName") && errorMsg2.get(0).equals(expectMessage))
				{
					...
					String[] inputFieldNames = {"Input_UserName: ", "Input_affilTypeCode: ", "Input_affilTypeName: "};
	        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
	        		logger.info("Expected error message is getting received in response when the affilTypeNameis more than 65 characters length in JSON");
	        		logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the affilTypeNameis more than 65 characters length in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
					...
					test.fail("Expected error message is not getting received in response");
		        	ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,"", "", Wsstatus, ""+Wscode,
							responsestr, "Fail","affilTypeName"+ expectMessage );
		        	Assert.fail("Test Failed");
		        }
		    }else {
		    	if(Wscode!=400){
