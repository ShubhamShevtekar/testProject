	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
				...
				String expectMessage = resMsgs.monthOfYearNbmrBlankMsg;
				if(internalMsg.equals(expectMessage))
				{
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.monthOfYearNumberBlankMsg;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, monthOfYearNumber, monthOfYearShortName};
					String[] inputFieldNames = {"Input_UserName: ", "Input_monthOfYearNumber: ", "Input_monthOfYearShortName: "};
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.monthOfYearNumberLengthMsg;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, monthOfYearNumber, monthOfYearShortName};
					String[] inputFieldNames = {"Input_UserName: ", "Input_monthOfYearNumber: ", "Input_monthOfYearShortName: "};
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.monthOfYearShortLengthMsg;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, monthOfYearNumber, monthOfYearShortName};
					String[] inputFieldNames = {"Input_UserName: ", "Input_monthOfYearNumber: ", "Input_monthOfYearShortName: "};
