...
public class LanguagePut extends Reporting {
	...
	public void TC_01() {
		...
		try {
			...
			// Count
			String langPutAuditCountQuery1 = query.langPutAuditCountQuery1(langCd);
			...
			String langPutAuditCountQuery2 = query.langPutAuditCountQuery2(langCd);
			...
			String langPutAuditCountQuery3 = query.langPutAuditCountQuery3(langCd);
			...
			if (Wscode == 200 && meta != null && Wsstatus.equalsIgnoreCase("SUCCESS") && (!meta.contains("timestamp"))
				...
				if (js.getString("data.langCd") != null) {
					...
					if (internalMsg.equals(expectMessage)) {
						...
						String[] inputFieldNames = { "Input_langCd: ", "Input_englLanguageNm: ",
						...
						String[] dbFieldNames = { "DB_langCd: ", "DB_englLanguageNm: ", "DB_nativeScriptLanguageNm:",
								"DB_LastUpdateUserName: ", "DB_dowNbr1:", "DB_transDowName1:", "DB_dowNbr2:",
								"DB_transDowName2:", "DB_dowNbr3:", "DB_transDowName3:", "DB_dowNbr4:",
								"DB_transDowName4:", "DB_dowNbr5:", "DB_transDowName5:", "DB_dowNbr6:",
								"DB_transDowName6:", "DB_dowNbr7:", "DB_transDowName7:", "DB_mthOfYrNbr1:",
								"DB_transMoyName1:", "DB_mthOfYrNbr2:", "DB_transMoyName2:", "DB_mthOfYrNbr3:",
								"DB_transMoyName3:", "DB_mthOfYrNbr4:", "DB_transMoyName4:", "DB_mthOfYrNbr5:",
						...
						// After Count
						String langPutAuditAfterCountQuery1 = query.langPutAuditCountQuery1(langCd);
						...
						String langPutAuditAfterCountQuery2 = query.langPutAuditCountQuery2(langCd);
						...
						String langPutAuditAfterCountQuery3 = query.langPutAuditCountQuery3(langCd);
						...
						if (testResult) {
							...
							inputAuditFieldValues[0] = langCd;
							inputAuditFieldValues[1] = englLanguageNm;
							inputAuditFieldValues[2] = nativeScriptLanguageNm;
							...
							String[] inputAuditFieldNames = { "Input_langCd: ", "Input_englLanguageNm: ",
									"Input_nativeScriptLanguageNm:", "Input_LastUpdateUserName: ",
									"Expected_RevisionTypeCd:", "Input_dowNbr1:", "Input_transDowName1:",
									"Expected_transDowName1RevisonCd:", "Input_dowNbr2:", "Input_transDowName2:",
									"Expected_transDowName2RevisonCd:", "Input_dowNbr3:", "Input_transDowName3:",
									"Expected_transDowName3RevisonCd:", "Input_dowNbr4:", "Input_transDowName4:",
									"Expected_transDowName4RevisonCd:", "Input_dowNbr5:", "Input_transDowName5:",
									"Expected_transDowName5RevisonCd:", "Input_dowNbr6:", "Input_transDowName6:",
									"Expected_transDowName6RevisonCd:", "Input_dowNbr7:", "Input_transDowName7:",
									"Expected_transDowName7RevisonCd:", "Input_mthOfYrNbr1:", "Input_transMoyName1:",
									"Input_transMoyName1RevisonCd:", "Input_mthOfYrNbr2:", "Input_transMoyName2:",
									"Expected_transMoyName2RevisonCd:", "Input_mthOfYrNbr3:", "Input_transMoyName3:",
									"Expected_transMoyName3RevisonCd:", "Input_mthOfYrNbr4:", "Input_transMoyName4:",
									"Expected_transMoyName4RevisonCd:", "Input_mthOfYrNbr5:", "Input_transMoyName5:",
									"Expected_transMoyName5RevisonCd:", "Input_mthOfYrNbr6:", "Input_transMoyName6:",
									"Expected_transMoyName6RevisonCd:", "Input_mthOfYrNbr7:", "Input_transMoyName7:",
									"Expected_transMoyName7RevisonCd:", "Input_mthOfYrNbr8:", "Input_transMoyName8:",
									"Expected_transMoyName8RevisonCd:", "Input_mthOfYrNbr9:", "Input_transMoyName9:",
									"Expected_transMoyName9RevisonCd:", "Input_mthOfYrNbr10:", "Input_transMoyName10:",
									"Expected_transMoyName10RevisonCd:", "Input_mthOfYrNbr11:", "Input_transMoyName11:",
									"Expected_transMoyName11RevisonCd:", "Input_mthOfYrNbr12:", "Input_transMoyName12:",
									"Expected_transMoyName12RevisonCd:" };

							writableAuditInputFields = Miscellaneous.geoFieldInputNames(inputAuditFieldValues,
									inputAuditFieldNames);

							String[] auditDBFieldNames = { "DB_langCd: ", "DB_englLanguageNm: ",
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("englLanguageNm") && errorMsg2.get(0).equals(expectMessage)) {
					...
					test.info(writableInputFields.replaceAll("\n", "<br />"));
					logger.info(
							"Expected error message is getting received in response when nativeScriptLanguageNm is not passed in JSON request");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when nativeScriptLanguageNm is not passed in JSON request");
	...
	public void TC_25() {
		...
		try {
			...
			if (getJMSResult != null) {
				...
				/*
				 * String nativeScriptLanguageNm1; String
				 * langCd=getJMSResult.getString("langCd"); String
				 * englLanguageNm=getJMSResult.getString("englLanguageNm");
				 * if(getJMSResult.isNull("nativeScriptLanguageNm"))
				 * nativeScriptLanguageNm1=""; else
				 * nativeScriptLanguageNm1=getJMSResult.getString(
				 * "nativeScriptLanguageNm");
				 */

				// BigInteger nativeScriptLanguageNm1 =
				// getJMSResult.getBigInteger("nativeScriptLanguageNm");
