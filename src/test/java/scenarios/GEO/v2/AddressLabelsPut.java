...
public class AddressLabelsPut extends Reporting {
	...
	String userId, geopoliticalId, countryCode, TestCaseDescription, scenarioType, brandAddressLineDescription,
			fullAddressLineDescription, languageCode, scriptCode;
	String addressLineNumber, applicable;
	...
	public void TC_01() {
		...
		try {
			...
			String payload = PostMethod.addressLabelPutRequest(userId, countryCode, addressLineNumber,
					brandAddressLineDescription, fullAddressLineDescription, languageCode, applicable, scriptCode);
			...
			if (Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta != null && (!meta.contains("timestamp"))
				...
				// ********
				String addressLabelPutQuery = query.addressLabelPutQuery(countryCode, addressLineNumber, brandAddressLineDescription, fullAddressLineDescription, languageCode, applicable, scriptCode);
				...
				List<String> getResultDB = DbConnect.getResultSetFor(addressLabelPutQuery, fields, fileName,
						testCaseID);
				if (js.getString("data.geopoliticalId") != null) {
					// ***success message validation
					if (internalMsg.equals(expectMessage)) {
						logger.info("geopoliticalId is getting updated and received in response: " + geopoliticalId);
						test.pass("geopoliticalId is getting updated and received in response: " + geopoliticalId);
						// ***send the input, response, DB result for validation
						String[] inputFieldValues = { userId, countryCode, addressLineNumber.toString(),
								brandAddressLineDescription, fullAddressLineDescription, languageCode,
								applicable.toString(), scriptCode };
						...
						String[] inputFieldNames = { "Input_UserName: ", "Input_countryCode: ",
								"Input_addressLineNumber: ", "Input_brandAddressLineDescription: ",
								"Input_fullAddressLineDescription: ", "Input_applicable: ", "Input_scriptCode: " };
						writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
						String[] dbFieldNames = { "DB_UserName: ", "DB_countryCode: ", "DB_addressLineNumber: ",
								"DB_brandAddressLineDescription: ", "DB_fullAddressLineDescription: ",
								"DB_applicable: ", "DB_scriptCode: " };
			...
			if (Wscode == 400) {
				...
				if (errorMsg1.get(0).equals("countryCode") && errorMsg2.get(0).equals(expectMessage)) {
					String[] inputFieldValues = { userId, countryCode, addressLineNumber.toString(),
							brandAddressLineDescription, fullAddressLineDescription, languageCode,
							applicable.toString(), scriptCode };
					String[] inputFieldNames = { "Input_UserName: ", "Input_countryCode: ", "Input_addressLineNumber: ",
							"Input_brandAddressLineDescription: ", "Input_fullAddressLineDescription: ",
							"Input_applicable: ", "Input_scriptCode: " };
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
					...
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "",
							Wsstatus, "" + Wscode, responsestr, "Fail", "countyCode" + expectMessage);
					Assert.fail("Test Failed");
				}
			} else {
				if (Wscode != 400) {
				...
				ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "", Wsstatus,
						"" + Wscode, responsestr, "Fail", "countyCode" + expectMessage);
				Assert.fail("Test Failed");
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
	        ...
	        if(Wscode == 404)
		    {
				...
				if(internalMsg.equals(expectMessage))
				{
					...
					writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
					logger.info(
							"Expected error message is getting received in response when sending the invalid URI");
					logger.info("Execution is completed for Passed Test Case No. " + testCaseID);
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when sending the invalid URI");
	...
	public void TC_13() {
		...
		try {
			...
			int Wscode = res.statusCode();
			String expectMessage = resMsgs.lengthExceeds2Char;
			String meta = js.getString("meta");
			String actualRespVersionNum = js.getString("meta.version");
			js.getString("meta.timestamp");
			if (Wscode == 400) {
	...
	public void TC_14() {
		...
		try {
			...
			int Wscode = res.statusCode();
			String expectMessage = resMsgs.lengthExceeds35Char;
			String meta = js.getString("meta");
			String actualRespVersionNum = js.getString("meta.version");
			js.getString("meta.timestamp");
			if (Wscode == 400) {
	...
	public void TC_15() {
		...
		try {
			...
			int Wscode = res.statusCode();
			String expectMessage = resMsgs.lengthExceeds80Char;
			String meta = js.getString("meta");
			String actualRespVersionNum = js.getString("meta.version");
			js.getString("meta.timestamp");
			if (Wscode == 400) {
	...
	public void TC_16() {
		...
		try {
			...
			int Wscode = res.statusCode();
			String expectMessage = resMsgs.lengthExceeds3Char1;
			String meta = js.getString("meta");
			String actualRespVersionNum = js.getString("meta.version");
			js.getString("meta.timestamp");
			if (Wscode == 400) {
	...
	public void TC_20() {
		...
		try {
			...
			test.log(Status.INFO, MarkupHelper.createLabel(TestCaseDescription, ExtentColor.PURPLE));
			// ***send the data to create request and get request
			String payload = PostMethod.addressLabelPutRequestWithoutMeta(userId, countryCode, addressLineNumber,
					brandAddressLineDescription, fullAddressLineDescription, languageCode, applicable, scriptCode);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void testDataFields(String scenarioName, String testCaseId) {
		...
		geopoliticalId = inputData1.get(testCaseId).get("geopolitical_id");
		countryCode = inputData1.get(testCaseId).get("country_cd");
		...
		languageCode = inputData1.get(testCaseId).get("line_number");
