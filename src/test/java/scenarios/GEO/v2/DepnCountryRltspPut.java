...
public class DepnCountryRltspPut extends Reporting{
	...
	String TestCaseDescription, scenarioType, userId, depnCntryRltspDesc, depnCntryRltspId;//, token;
	...
	{	
        ...
        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta !=null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
        {
    		...
    		List<String> getResultDB = DbConnect.getResultSetFor(depnCntryRltspPuttQuery, fields, fileName, testCaseID);
    		if(js.getString("data.dependentRelationshipId")!=null)
    		{
        		...
        		String[] inputFieldNames = {"Input_DepnCntryRltspId: ", "Input_DepnCntryRltspDesc: ", "Input_LastUpdateUserName: "};
        		writableInputFields = Miscellaneous.geoFieldInputNames(inputFieldValues, inputFieldNames);
        		String[] dbFieldNames = {"DB_DepnCntryRltspId: ", "DB_DepnCntryRltspDesc: ", "DB_LastUpdateUserName: "};
	...
	{	
		 ...
		 if(Wscode == 404 &&  meta != null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
			...
			{
				logger.info("Expected error message is getting received in response when the dependentRelationshipId is not exist in DB");
    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
    			logger.info("------------------------------------------------------------------");
    ...
    //    String internalMsg = js.getString("errorMessages.e");
		 ...
		 if(Wscode == 400 &&  meta != null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
			...
			if(errorMsg1.get(0).equals("Error") && errorMsg2.get(0).equals(expectMessage))
			{
				logger.info("Expected error message is getting received in response when the alphabets/ special characters are provided dependentRelationshipId");
    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
    			logger.info("------------------------------------------------------------------");
	...
	{	
      ...
      //  String internalMsg = js.getString("errorMessages.e");
		 ...
		 if(Wscode == 400 &&  meta != null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase(actuatorcommandversion))
	    {
			...
			if(errorMsg1.get(0).equals("Error") && errorMsg2.get(0).equals(expectMessage))
			{
				logger.info("Expected error message is getting received in response when the special characters are provided dependentRelationshipId");
    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
    			logger.info("------------------------------------------------------------------");
