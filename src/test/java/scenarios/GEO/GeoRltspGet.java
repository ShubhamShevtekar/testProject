...
public class GeoRltspGet extends Reporting{
	...
	String TestCaseDescription, scenarioType, relationshipTypeCode, fromGeopoliticalId, toGeopoliticalId, targetDate, endDate;
		        	...
		        	for(int j=0; j<getResultDB.size(); j=j+fields.size())
		        	{
	        				...
	        				)
		        		{
		        			...
		        			String[] responseDbFieldNames = {
		        					"Response_fromGeopoliticalId: ", "DB_fromGeopoliticalId: ", 
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta!=null )
	        {
	        	...
	        	String geoRsGetQuery = query.geopRltspWithTargetEndDatesGetQuery(relationshipTypeCode, targetDate , endDate);
	        	//***get the fields needs to be validate in DB
	    		List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
	    		//***get the result from DB
	    		List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta!=null )
	        {
	        	...
	        	String geoRsGetQuery = query.geopRltspWithFromAndToGeoplIdGetQuery(relationshipTypeCode, fromGeopoliticalId, toGeopoliticalId);
	        	//***get the fields needs to be validate in DB
	    		List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
	    		//***get the result from DB
	    		List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta!=null )
	        {
	        	...
	        	String geoRsGetQuery = query.geopRltspWithFromToGeoplIdAndTargetEndDatesGetQuery(relationshipTypeCode, targetDate , endDate, fromGeopoliticalId, toGeopoliticalId);
	        	//***get the fields needs to be validate in DB
	    		List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
	    		//***get the result from DB
	    		List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta!=null )
	        {
	        	...
	        	String geoRsGetQuery = query.geopRltspWithFromGeoplIdGetAndTargetEndDatesQuery(relationshipTypeCode, targetDate , endDate, fromGeopoliticalId);
	        	//***get the fields needs to be validate in DB
	    		List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
	    		//***get the result from DB
	    		List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS") && meta!=null )
	        {
	        	...
	        	String geoRsGetQuery = query.geopRltspWithToGeoplIdGetAndTargetEndDatesQuery(relationshipTypeCode, targetDate , endDate, toGeopoliticalId);
	        	//***get the fields needs to be validate in DB
	    		List<String> fields = ValidationFields.geopRltspGetMethodDbFields();
	    		//***get the result from DB
	    		List<String> getResultDB = DbConnect.getResultSetFor(geoRsGetQuery, fields, fileName, testCaseID);
