			...
			if (Wscode == 200 && meta != null && Wsstatus.equalsIgnoreCase("SUCCESS") && (!meta.contains("timestamp"))
				...
				if (js.getString("data.stProvCd") != null) {
					...
					if (internalMsg.equals(expectMessage)) {
						...
						String[] inputFieldValues = { userId, orgStdCd, stProvCd, stProvNm, effectiveDate,
						...
						if (testResult) {
							...
							String geoStProvStdPostQueryAudit = query.stProvStdAuditQuery(stProvCd, formatEffectiveDate,
									formatAuditExpirationDate, stProvNm);
							// ***get the fields needs to be validate in DB
							...
							String[] inputFieldValuesAudit = { userId, orgStdCd, stProvCd, stProvNm, effectiveDate,
							...
							if (testResult) {
								String[] inputFieldNamesAudit = { "Input_UserName: ", "Input_orgStdCd: ",
										"Input_stProvCd: ", "Input_stProvNm: ", "Input_effectiveDate",
								...
								String[] dbFieldNamesAudit = { "DB_UserName: ", "DB_orgStdCd: ", "DB_stProvCd: ",
										"DB_stProvNm: ", "DB_effectiveDate", "DB_expirationDate",
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("stProvCd") && errorMsg2.get(0).equals(expectMessage)) {
					...
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the empty value is passed in JSON for stProvCd ");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,
							writableInputFields, "NA", Wsstatus, "" + Wscode, responsestr1, "Pass", "");
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				} else {
		...
		try {
			...
			if (Wscode == 404 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("orgStdCd") && errorMsg2.get(0).equals(expectMessage)) {
					...
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when invalid orgstdCd (Not exist in Geopl_org_std table) is passed in JSON");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,
							writableInputFields, "NA", Wsstatus, "" + Wscode, responsestr1, "Pass", "");
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				} else {
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("stProvCd") && errorMsg2.get(0).equals(expectMessage)) {
					...
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the stProvCd attribute is not passed in JSON");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,
							writableInputFields, "NA", Wsstatus, "" + Wscode, responsestr1, "Pass", "");
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				} else {
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("stProvCd") && errorMsg2.get(0).equals(expectMessage)) {
					...
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the  stProvCd is more than 10 characters length in JSON");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,
							writableInputFields, "NA", Wsstatus, "" + Wscode, responsestr1, "Pass", "");
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				} else {
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))
				...
				if (errorMsg1.get(0).equals("stProvNm") && errorMsg2.get(0).equals(expectMessage)) {
					...
					logger.info("------------------------------------------------------------------");
					test.pass(
							"Expected error message is getting received in response when the  stProvNm is more than 120 characters length in JSON");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,
							writableInputFields, "NA", Wsstatus, "" + Wscode, responsestr1, "Pass", "");
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				} else {
