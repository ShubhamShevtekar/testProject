	...
	{	
		...
		try {
	        ...
	        if(Wscode == 200 && Wsstatus.equalsIgnoreCase("SUCCESS"))
	        {
	        	...
	        	//***get the DB query
	    		String geoStProvStdPostQuery = query.stProvStdPostQuery(stProvCd,formatEffectiveDate);
	    		//***get the fields needs to be validate in DB
	    		List<String> fields = ValidationFields.stProvStdDbFields();
	    		System.out.println(fields.size());
	    		//***get the result from DB
	    		List<String> getResultDB = DbConnect.getResultSetFor(geoStProvStdPostQuery, fields, fileName, testCaseID);
	    		if(js.getString("data.stProvCd")!=null)
	    		{
	    			String stProvCd1 = js.getString("data.stProvCd");
	    			//***success message validation
	    			String expectMessage = resMsgs.stProvStdPostSuccessMsg+stProvCd1;
	    			if(internalMsg.equals(expectMessage))
	    			{
	    				...
	    				String[] inputFieldValues = {userId, orgStdCd, stProvCd, stProvNm, effectiveDate, expirationDate, userId};
	            		...
	            		String[] dbFieldNames = {"DB_UserName: ", "DB_orgStdCd: ", "DB_stProvCd: ", "DB_stProvNm: ", 
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
				...
				String expectMessage = resMsgs.stProvStdOrgStdCdBlankMsg;
				if(internalMsg.equals(expectMessage))
				{
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when sending the blank OrgStdCode");
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.stProvStdstProvCdBlankMsg;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, orgStdCd, stProvCd, stProvNm, effectiveDate, expirationDate};
					String[] inputFieldNames = {"Input_UserName: ", "Input_orgStdCd: ", "Input_stProvCd: ", "Input_stProvNm: ", 
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the empty value is passed in JSON for stProvCd ");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
		...
		try {
	        ...
	        if(Wscode == 404)
		    {
				...
				if(internalMsg.equals(expectMessage))
				{
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when invalid orgstdCd (Not exist in Geopl_org_std table) is passed in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.stProvStdOrgStdCdBlankMsg1;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, orgStdCd, stProvCd, stProvNm, effectiveDate, expirationDate};
					String[] inputFieldNames = {"Input_UserName: ", "Input_orgStdCd: ", "Input_stProvCd: ", "Input_stProvNm: ", 
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the orgstdCd attribute is not passed in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
				...
				if(internalMsg.equals(expectMessage))
				{
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the stProvCd attribute is not passed in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.stProvStdOrgStdCdLengthMsg;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, orgStdCd, stProvCd, stProvNm, effectiveDate, expirationDate};
					String[] inputFieldNames = {"Input_UserName: ", "Input_orgStdCd: ", "Input_stProvCd: ", "Input_stProvNm: ", 
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the orgstdCd is more than 10 characters length in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.stProvStdstProvCdLengthMsg;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, orgStdCd, stProvCd, stProvNm, effectiveDate, expirationDate};
					String[] inputFieldNames = {"Input_UserName: ", "Input_orgStdCd: ", "Input_stProvCd: ", "Input_stProvNm: ", 
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the  stProvCd is more than 10 characters length in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
	...
	{	
		...
		try {
	        ...
	        if(Wscode == 400)
		    {
	        	...
	        	test.pass("Response status code 400 validation passed: "+Wscode);
	        	//***error message validation
				String expectMessage = resMsgs.stProvStdstProvNmLengthMsg;
				if(internalMsg.equals(expectMessage))
				{
					String[] inputFieldValues = {userId, orgStdCd, stProvCd, stProvNm, effectiveDate, expirationDate};
					String[] inputFieldNames = {"Input_UserName: ", "Input_orgStdCd: ", "Input_stProvCd: ", "Input_stProvNm: ", 
	    			...
	    			logger.info("Execution is completed for Passed Test Case No. "+testCaseID);
	    			logger.info("------------------------------------------------------------------");
	        		test.pass("Expected error message is getting received in response when the  stProvNm is more than 120 characters length in JSON");
	        		ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted,	writableInputFields, "NA",
	    					Wsstatus, ""+Wscode, responsestr1, "Pass", "" );
					test.log(Status.PASS, MarkupHelper.createLabel("test status", ExtentColor.GREEN));
				}else {
