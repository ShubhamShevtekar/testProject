...
public class CntryOrgStdPost extends Reporting {
	...
	String TestCaseDescription, scenarioType, userId, countryCode, countryShortName, countryFullName, orgStandardCode,
	...
	public void TC_01() {
		...
		try {
			...
			String payload = PostMethod.cntryOrgStdPostRequest(userId, countryCode, countryShortName, countryFullName,
					orgStandardCode, effectiveDate, expirationDate);
			...
			if (Wscode == 200 && meta != null && Wsstatus.equalsIgnoreCase("SUCCESS")
					&& (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase("1.0.0")) {
				...
				String countryOrgStdPostQuery = query.countryOrgStdPostQuery(countryCode, countryShortName,
						countryFullName, orgStandardCode, formatEffectiveDate, formatExpirationDate);
				...
				if (js.getString("data.orgStdCd") != null && js.getString("data.geoplId") != null) {
					...
					if (internalMsg.equals(expectMessage)) {
						...
						String[] inputFieldValues = { userId, geopId, countryShortName, countryFullName,
								orgStandardCode, effectiveDate, expirationDate, userId };
						...
						String[] inputFieldNames = { "Input_UserName: ", "Response_GeoId: ", "Input_CountryShortName: ",
								"Input_CountryFullame: ", "Input_orgStandardCode: ", "Input_effectiveDate: ",
						...
						String[] dbFieldNames = { "DB_UserName: ", "DB_GeoId: ", "DB_CountryShortName: ",
								"DB_CountryFullame: ", "DB_orgStandardCode: ", "DB_effectiveDate: ",
						...
						if (testResult) {
							...
							String countryOrgStdPostAuditQuery = query.countryOrgStdPostAuditQuery(countryCode,
									countryShortName, countryFullName, orgStandardCode, formatAuditEffectiveDate,
									formatAuditExpirationDate);
							// ***get the fields needs to be validate in DB
							...
							String[] inputAuditFieldValues = { userId, geopId, countryShortName, countryFullName,
									orgStandardCode, effectiveDate, expirationDate, userId, "0" };
							testResult = false;
							...
							if (testResult) {
								String[] inputFieldNamesAudit = { "Input_UserName: ", "Response_GeoId: ",
										"Input_CountryShortName: ", "Input_CountryFullame: ", "Input_orgStandardCode: ",
		...
		try {
			...
			if (Wscode == 400 && meta != null && (!meta.contains("timestamp"))&& actualRespVersionNum.equalsIgnoreCase("1.0.0")) {
				...
				if (errorMsg1.get(0).equals("orgStandardCode") && errorMsg2.get(0).equals(expectMessage)) {
					...
					test.fail("Expected error message is not getting received as expected in response");
					ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "",
							Wsstatus, "" + Wscode, responsestr, "Fail", "orgStandardCode" + expectMessage);
					Assert.fail("Test Failed");
				}
			} else {
				if (Wscode != 400) {
				...
				ex.writeExcel(fileName, testCaseID, TestCaseDescription, scenarioType, reqFormatted, "", "", Wsstatus,
						"" + Wscode, responsestr, "Fail", "orgStandardCode" + expectMessage);
				Assert.fail("Test Failed");
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void TC_12() {
		...
		try {
			...
			String payload = PostMethod.cntryOrgStdPostRequestWithoutMeta(userId, countryCode, countryShortName,
					countryFullName, orgStandardCode, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
	...
	public void TC_17() {
		...
		try {
			...
			String payload = PostMethod.cntryOrgStdPostRequestWithoutEffectiveDate(userId, countryCode,
					countryShortName, countryFullName, orgStandardCode, effectiveDate, expirationDate);
			String reqFormatted = Miscellaneous.jsonFormat(payload);
			test.info("Input Request created:");
			logger.info("Input Request created");
			test.info(reqFormatted.replaceAll("\n", "<br />"));
