...
public class ExpirationDateDeserializer extends StdDeserializer<Date>{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ExpirationDateDeserializer.class);
	...
	public ExpirationDateDeserializer(Class<?> vc) {
		super(vc);
	}
	...
	public Date deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
		...
		if(StringUtils.isEmpty(date)){
			return CommonUtility.getDefaultExpirationDate();
		}
