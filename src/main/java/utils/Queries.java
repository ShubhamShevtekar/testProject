...
//	}
	...
	public String cntryCountryDialingsPostAuditQuery(String whereField1,String whereField2,String whereField3,String whereField4) {
		String geoPostQuery = "SELECT GEOPL_ID" +
				"        ,INTL_DIAL_PREFX_CD" +
				"        ,INTL_DIAL_CD" +
				"        ,LAND_PH_MAX_LTH_NBR" +
...
//				" (effective_dt <=to_date('"+ whereField3 +"','YYYY-MM-DD'))))))";		
	...
	public String countryGraphQLQuery(String whereField1) {
		String geoPostQuery = "select GEOPL_ID, CNTRY_NUM_CD, CNTRY_CD, THREE_CHAR_CNTRY_CD, INDPT_FLG, DEPN_RLTSP_ID, DEPN_CNTRY_CD, PSTL_FORMT_DESC, PSTL_FLG, PSTL_LTH_NBR, FIRST_WORK_WK_DAY_NM, LAST_WORK_WK_DAY_NM, " + 
				" WKEND_FIRST_DAY_NM, INET_DOMN_NM, to_char(EFFECTIVE_DT,'YYYY-MM-DD') \"EFFECTIVE_DT\", to_char(EXPIRATION_DT,'YYYY-MM-DD') \"EXPIRATION_DT\" from country where geopl_id='"+ whereField1 +"'";
	...
	public String countryDialGetQuery(String whereField, String whereField2, String whereField3) {
		String geoPostQuery = "select geopl_id,INTL_DIAL_PREFX_CD, INTL_DIAL_CD, MOBL_PH_MIN_LTH_NBR, MOBL_PH_MAX_LTH_NBR, LAND_PH_MIN_LTH_NBR, LAND_PH_MAX_LTH_NBR, " + 
	...
	public String AddressLabelsGettQuery(String whereField) {
		...
		//Address Label PUT
		public String addressLabelPutQuery(String whereField1, String whereField2, String whereFiel3d) {
			String geoPostQuery = "select * from geopl_affil_type where AFFIL_TYPE_CD='" + whereField1 + "'";		
			return geoPostQuery;
		}
}
